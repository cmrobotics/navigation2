...
/**
 * @class NavigateToNamedPoseNavigator
 * @brief A navigator for navigating to a specified pose
 */
class NavigateToNamedPoseNavigator
  : public nav2_bt_navigator::Navigator<cmr_msgs::action::NavigateToNamedPose>
{
public:
  using ActionT = cmr_msgs::action::NavigateToNamedPose;

  /**
   * @brief A constructor for NavigateToNamedPoseNavigator
   */
  NavigateToNamedPoseNavigator()
  : Navigator() {}
   ...
   */
  void onGoalPoseReceived(const std_msgs::msg::String::SharedPtr named_pose);
