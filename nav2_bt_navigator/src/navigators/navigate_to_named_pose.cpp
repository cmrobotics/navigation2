...
#include <memory>
#include <limits>
#include "nav2_bt_navigator/navigators/navigate_to_named_pose.hpp"

namespace nav2_bt_navigator
{

bool
NavigateToNamedPoseNavigator::configure(
  ...
  std::shared_ptr<nav2_util::OdomSmoother> odom_smoother)
{
  ...
  goal_sub_ = node->create_subscription<std_msgs::msg::String>(
    ...
    std::bind(&NavigateToNamedPoseNavigator::onGoalPoseReceived, this, std::placeholders::_1));
  return true;
}

std::string
NavigateToNamedPoseNavigator::getDefaultBTFilepath(
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
...
bool
NavigateToNamedPoseNavigator::cleanup()
{
  goal_sub_.reset();
  self_client_.reset();
  return true;
...
bool
NavigateToNamedPoseNavigator::goalReceived(ActionT::Goal::ConstSharedPtr goal)
{
...
void
NavigateToNamedPoseNavigator::goalCompleted(typename ActionT::Result::SharedPtr /*result*/)
{
}

void
NavigateToNamedPoseNavigator::onLoop()
{
...
void
NavigateToNamedPoseNavigator::onPreempt(ActionT::Goal::ConstSharedPtr goal)
{
...
NavigateToNamedPoseNavigator::initializeGoalPose(ActionT::Goal::ConstSharedPtr goal)
{
  ...
  blackboard->set<geometry_msgs::msg::PoseStamped>(goal_blackboard_id_, pose);
}

void
NavigateToNamedPoseNavigator::onGoalPoseReceived(const std_msgs::msg::String::SharedPtr str_msg)
{
  ActionT::Goal goal;
  goal.location = str_msg->data;
